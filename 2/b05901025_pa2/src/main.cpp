...
int main(int argc, char** argv) 
{
    ...
    while ( i < 2 )
    {
        i++;
        p1Time = time(NULL);
        if ( router.preRoute() != 0 ) break;
        router.setTimer(10000 - 1.5*(time(NULL) - p1Time));
        cout <<  time(NULL) - p1Time << endl;
    }
    //timeReport << "PreRoute1 time : " << p1Time - startTime << endl;
    //cout << "PreRoute1 time : " << p1Time - startTime << endl;

    //p2Time = time(NULL);
    //timeReport << "PreRoute2 time : " << p2Time - p1Time << endl;
    //cout << "PreRoute2 time : " << p2Time - p1Time << endl;
    //cout << "Route all ...\n";
    router.routeAll( f );
    f.close();

    //timeReport << "Route time : " << time(NULL) - p2Time << endl;    
    //cout << "Route time : " << time(NULL) - p2Time << endl;    
