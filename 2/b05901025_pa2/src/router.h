...
class DijstraMap
{
    ...
    void incrpreLoad ( const Vertice* _pin1, const Vertice* _pin2 );
    ...
    short **vCapacity, **hCapacity, **vLoad, **hLoad; 
...
public:
    ...
    bool preRoute();
    void setTimer( time_t t ) { preRouteStopTime = t; }

private:
    bool isPreRoute;
    DijstraMap *dMap;
    time_t startTime, preRouteStopTime;
